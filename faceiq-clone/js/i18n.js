(function () {
  ...
  var T = {
    en: {
      ...
      landing: {
        pill: "Morphology index",
        heroTitle: "Your face, <span>indexed.</span>",
        heroSubtitle: "MorphIndex reads structure — not opinions. Two photos become a living scorecard with pillars, priorities, and proof every time you re-scan.",
        vars: "variables per scan",
        panelFoot: "Last scan · 3 days ago · Plan 73% on track",
        decoScore: "Overall index",
        decoUp: "+0.28",
        appMeta: "Top 18% · Potential 8.1",
        appNext: "Next action",
        appNextBody: "Sleep protocol · Week 2, Day 4",
        faqTitle: "Questions",
    ...
    fr: {
      ...
      landing: {
        pill: "Index morphologique",
        heroTitle: "Votre visage, <span>indexé.</span>",
        heroSubtitle: "MorphIndex lit la structure — pas les avis. Deux photos deviennent un tableau de bord vivant avec piliers, priorités et preuves à chaque re-scan.",
        vars: "variables par scan",
        panelFoot: "Dernier scan · il y a 3 j · Plan 73 % en cours",
        decoScore: "Index global",
        decoUp: "+0,28",
        appMeta: "Top 18 % · Potentiel 8,1",
        appNext: "Prochaine action",
        appNextBody: "Protocole sommeil · Semaine 2, Jour 4",
        faqTitle: "Questions",
    ...
    es: {
      ...
      landing: {
        pill: "Índice morfológico",
        heroTitle: "Tu rostro, <span>indexado.</span>",
        heroSubtitle: "MorphIndex lee la estructura — no las opiniones. Dos fotos se convierten en un panel vivo con pilares, prioridades y prueba en cada re-escaneo.",
        vars: "variables por escaneo",
        panelFoot: "Último escaneo · hace 3 d · Plan 73 % en curso",
        decoScore: "Índice global",
        decoUp: "+0,28",
        appMeta: "Top 18 % · Potencial 8,1",
        appNext: "Próxima acción",
        appNextBody: "Protocolo sueño · Semana 2, Día 4",
        faqTitle: "Preguntas",
