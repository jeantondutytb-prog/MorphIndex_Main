(function () {
  ...
  var T = {
    en: {
      ...
      nav: { celebs: "Profiles", creators: "Community", how: "How it works", faq: "FAQ", login: "Login", cta: "Try MorphIndex", ctaShort: "Try MorphIndex" },
      landing: {
        pill: "Facial analysis · Live metrics",
        heroTitle: "Decode your morphology<br><em>in under 2 minutes.</em>",
        heroSubtitle: "Two photos. A structured scorecard. A prioritized roadmap — and proof of progress every time you re-scan.",
        decoScore: "Overall index",
        decoViews: "Scans · 30 days",
        decoUp: "index",
        decoNotifTitle: "New scan completed",
        decoNotifSub: "just now · Harmony +0.3",
        feat1tag: "1 scan",
        feat1t: "One scan. Your index in seconds",
        feat1d: "Upload a front and side photo — MorphIndex maps 100+ variables into a single composite score you can act on.",
        feat2tag: "Structure",
        feat2t: "Your metrics tell the full story",
        feat2d: "Harmony, jawline, traits, skin — each dimension scored independently so you know exactly where to focus.",
        feat3tag: "Progress",
        feat3t: "Full traceability of your gains",
        feat3d: "Re-scan over time and watch your index climb. Every session is logged — you see what moves the needle.",
        strip: "MorphIndex covers <strong>harmony, structure, traits &amp; skin</strong> in one workflow",
        problemTitle: "In 2026, guessing your weak spots doesn't cut it.",
        problemText: "<strong>88%</strong> of appearance advice is subjective — MorphIndex replaces opinions with measurable structure.",
        membersEyebrow: "Community",
        membersTitle: "They already track their morphology",
        membersSubtitle: "Members who scan regularly — sharing their index growth.",
        membersCta: "Start my scan",
        analyticsEyebrow: "Dashboard",
        analyticsTitle: "Measure what your scans actually produce",
        analyticsSubtitle: "Index shifts, pillar breakdowns, plan completion — every session tracked so you know what converts.",
        stat1l: "Overall index", stat1s: "+18% over 90 days",
        stat2l: "Harmony score", stat2s: "Top pillar this month",
        stat3l: "Plan actions", stat3s: "Completed this week",
        stat4l: "Re-scans", stat4s: "Logged in 6 months",
        faqTitle: "Still have questions?<span>We've got answers.</span>",
        faq1q: "What is MorphIndex?",
        faq1a: "MorphIndex turns your facial photos into structured metrics — harmony, jawline, traits, and skin — plus a personalized improvement plan you can track over time.",
        faq2q: "How do I get started?",
        faq2a: "Create an account, upload a front photo and a side profile, and your full analysis is generated in minutes. Re-scan anytime to measure progress.",
        faq3q: "Is MorphIndex a replacement for professional advice?",
        faq3a: "MorphIndex is a measurement and planning tool — not medical advice. It helps you understand your structure and prioritize next steps; always consult a qualified professional for clinical decisions.",
        faq4q: "Can I track progress over time?",
        faq4a: "Yes. Every re-scan is logged against your history. You see index shifts, pillar breakdowns, and whether your plan is moving the numbers.",
        faq5q: "Is MorphIndex free to try?",
        faq5a: "You can create an account and run your first scan to explore the platform. Premium features unlock your full roadmap, coach, and progress tracking.",
        faqCta: "Didn't find what you need?",
        faqCtaLink: "Start your first scan"
      },
      hero: {
    ...
    fr: {
      ...
      nav: { celebs: "Profils", creators: "Communauté", how: "Comment ça marche", faq: "FAQ", login: "Connexion", cta: "Essayer MorphIndex", ctaShort: "Essayer" },
      landing: {
        pill: "Analyse faciale · Métriques en direct",
        heroTitle: "Décryptez votre morphologie<br><em>en moins de 2 minutes.</em>",
        heroSubtitle: "Deux photos. Un tableau de bord structuré. Une feuille de route priorisée — et une preuve de progression à chaque re-scan.",
        decoScore: "Index global",
        decoViews: "Scans · 30 jours",
        decoUp: "index",
        decoNotifTitle: "Nouveau scan terminé",
        decoNotifSub: "à l'instant · Harmonie +0,3",
        feat1tag: "1 scan",
        feat1t: "Un scan. Votre index en quelques secondes",
        feat1d: "Ajoutez une photo de face et de profil — MorphIndex transforme plus de 100 variables en un score composite actionnable.",
        feat2tag: "Structure",
        feat2t: "Vos métriques racontent toute l'histoire",
        feat2d: "Harmonie, mâchoire, traits, peau — chaque dimension est notée indépendamment pour savoir exactement où agir.",
        feat3tag: "Progression",
        feat3t: "Une traçabilité complète de vos gains",
        feat3d: "Re-scannez dans le temps et voyez votre index grimper. Chaque session est enregistrée — vous savez ce qui fait bouger les chiffres.",
        strip: "MorphIndex couvre <strong>harmonie, structure, traits &amp; peau</strong> dans un seul workflow",
        problemTitle: "En 2026, deviner ses points faibles ne suffit plus.",
        problemText: "<strong>88 %</strong> des conseils beauté sont subjectifs — MorphIndex remplace les avis par une structure mesurable.",
        membersEyebrow: "Communauté",
        membersTitle: "Ils suivent déjà leur morphologie",
        membersSubtitle: "Des membres qui scannent régulièrement — et partagent leur progression d'index.",
        membersCta: "Lancer mon scan",
        analyticsEyebrow: "Tableau de bord",
        analyticsTitle: "Mesurez ce que vos scans produisent vraiment",
        analyticsSubtitle: "Évolution de l'index, piliers, plan d'action — chaque session est suivie pour savoir ce qui convertit.",
        stat1l: "Index global", stat1s: "+18 % sur 90 jours",
        stat2l: "Score harmonie", stat2s: "Meilleur pilier ce mois-ci",
        stat3l: "Actions du plan", stat3s: "Complétées cette semaine",
        stat4l: "Re-scans", stat4s: "Enregistrés en 6 mois",
        faqTitle: "Encore des questions ?<span>On a les réponses.</span>",
        faq1q: "Qu'est-ce que MorphIndex ?",
        faq1a: "MorphIndex transforme vos photos faciales en métriques structurées — harmonie, mâchoire, traits et peau — plus un plan d'amélioration personnalisé que vous pouvez suivre dans le temps.",
        faq2q: "Comment démarrer ?",
        faq2a: "Créez un compte, importez une photo de face et une de profil, et votre analyse complète est générée en quelques minutes. Re-scannez quand vous voulez pour mesurer vos progrès.",
        faq3q: "MorphIndex remplace-t-il un avis professionnel ?",
        faq3a: "MorphIndex est un outil de mesure et de planification — pas un avis médical. Il vous aide à comprendre votre structure et à prioriser les prochaines étapes ; consultez toujours un professionnel qualifié pour les décisions cliniques.",
        faq4q: "Puis-je suivre ma progression dans le temps ?",
        faq4a: "Oui. Chaque re-scan est enregistré dans votre historique. Vous voyez l'évolution de l'index, le détail par pilier et si votre plan fait bouger les chiffres.",
        faq5q: "MorphIndex est-il gratuit pour essayer ?",
        faq5a: "Vous pouvez créer un compte et lancer votre premier scan pour explorer la plateforme. Les fonctionnalités premium débloquent votre feuille de route complète, le coach et le suivi de progression.",
        faqCta: "Vous n'avez pas trouvé votre bonheur ?",
        faqCtaLink: "Lancer mon premier scan"
      },
      hero: {
    ...
    es: {
      ...
      nav: { celebs: "Perfiles", creators: "Comunidad", how: "Cómo funciona", faq: "FAQ", login: "Iniciar sesión", cta: "Probar MorphIndex", ctaShort: "Probar" },
      landing: {
        pill: "Análisis facial · Métricas en vivo",
        heroTitle: "Descifra tu morfología<br><em>en menos de 2 minutos.</em>",
        heroSubtitle: "Dos fotos. Un panel estructurado. Una hoja de ruta priorizada — y prueba de progreso en cada re-escaneo.",
        decoScore: "Índice global",
        decoViews: "Escaneos · 30 días",
        decoUp: "índice",
        decoNotifTitle: "Nuevo escaneo completado",
        decoNotifSub: "ahora · Armonía +0,3",
        feat1tag: "1 escaneo",
        feat1t: "Un escaneo. Tu índice en segundos",
        feat1d: "Sube una foto frontal y otra de perfil — MorphIndex convierte más de 100 variables en un puntaje compuesto accionable.",
        feat2tag: "Estructura",
        feat2t: "Tus métricas cuentan toda la historia",
        feat2d: "Armonía, mandíbula, rasgos, piel — cada dimensión se puntúa de forma independiente para saber exactamente dónde enfocarte.",
        feat3tag: "Progreso",
        feat3t: "Trazabilidad completa de tus avances",
        feat3d: "Re-escanea con el tiempo y observa cómo sube tu índice. Cada sesión queda registrada — ves qué mueve la aguja.",
        strip: "MorphIndex cubre <strong>armonía, estructura, rasgos y piel</strong> en un solo flujo",
        problemTitle: "En 2026, adivinar tus puntos débiles ya no basta.",
        problemText: "El <strong>88 %</strong> de los consejos de apariencia son subjetivos — MorphIndex sustituye las opiniones por estructura medible.",
        membersEyebrow: "Comunidad",
        membersTitle: "Ya siguen su morfología",
        membersSubtitle: "Miembros que escanean con regularidad — compartiendo el crecimiento de su índice.",
        membersCta: "Iniciar mi escaneo",
        analyticsEyebrow: "Panel",
        analyticsTitle: "Mide lo que tus escaneos producen de verdad",
        analyticsSubtitle: "Cambios de índice, pilares, plan de acción — cada sesión registrada para saber qué convierte.",
        stat1l: "Índice global", stat1s: "+18 % en 90 días",
        stat2l: "Puntaje armonía", stat2s: "Mejor pilar este mes",
        stat3l: "Acciones del plan", stat3s: "Completadas esta semana",
        stat4l: "Re-escaneos", stat4s: "Registrados en 6 meses",
        faqTitle: "¿Aún tienes preguntas?<span>Tenemos respuestas.</span>",
        faq1q: "¿Qué es MorphIndex?",
        faq1a: "MorphIndex convierte tus fotos faciales en métricas estructuradas — armonía, mandíbula, rasgos y piel — más un plan de mejora personalizado que puedes seguir en el tiempo.",
        faq2q: "¿Cómo empiezo?",
        faq2a: "Crea una cuenta, sube una foto frontal y otra de perfil, y tu análisis completo se genera en minutos. Re-escanea cuando quieras para medir tu progreso.",
        faq3q: "¿MorphIndex sustituye el consejo profesional?",
        faq3a: "MorphIndex es una herramienta de medición y planificación — no consejo médico. Te ayuda a entender tu estructura y priorizar los siguientes pasos; consulta siempre a un profesional cualificado para decisiones clínicas.",
        faq4q: "¿Puedo seguir mi progreso en el tiempo?",
        faq4a: "Sí. Cada re-escaneo se registra en tu historial. Ves cambios de índice, desglose por pilares y si tu plan está moviendo los números.",
        faq5q: "¿MorphIndex es gratis para probar?",
        faq5a: "Puedes crear una cuenta y hacer tu primer escaneo para explorar la plataforma. Las funciones premium desbloquean tu hoja de ruta completa, el coach y el seguimiento de progreso.",
        faqCta: "¿No encontraste lo que buscabas?",
        faqCtaLink: "Inicia tu primer escaneo"
      },
      hero: {
